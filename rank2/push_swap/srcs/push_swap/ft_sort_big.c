...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/07/24 05:28:41 by mhashir           #+#    #+#             */
/*   Updated: 2024/07/25 03:34:49 by mhashir          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_sort_b_till_3(t_stack **stack_a, t_stack **stack_b)
{
	...
	while (get_listsize(*stack_a) > 3 && !ft_checksorted(*stack_a))
	{
		tmp = *stack_a;
...
t_stack	*ft_sort_b(t_stack **stack_a)
{
	...
	stack_b = NULL;
	if (get_listsize(*stack_a) > 3 && !ft_checksorted(*stack_a))
