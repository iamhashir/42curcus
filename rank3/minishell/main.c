...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/12/31 01:08:18 by mhashir           #+#    #+#             */
/*   Updated: 2025/06/25 06:01:34 by mhashir          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	print_tokens(t_token *tokens)
{
	const char	*type_names[] = {
		"IDENTIFIER", "LESS", "GREAT", "DLESS", "DGREAT",
		"PIPE", "OPEN_PAREN", "CLOSE_PAREN", "AND", "OR", "NL"
	};
