...
- Real-time multiplayer gaming platform (Team of 4)
- **Role:** Team Lead, System Architect & Reactor Framework Architect (designed & built custom 3kb JSX runtime)
...
**ft_transcendence is a real-time, distributed multiplayer gaming platform**, developed as the final capstone of the 42 curriculum. **This project was executed by a team of four under Malik's technical leadership and architectural direction.**
...
**System Architect • Product Owner • Project Manager • Lead Engineer**

Malik drove the project end-to-end, leading a cross-functional team of four to deliver a high-performance gaming platform. He defined the system boundaries and technical direction while actively engineering the most critical core components across the stack.

**As Team Lead, he:**
- **Product Strategy:** Defined the overall product vision, roadmap, and feature priorities for the 4-person team.
- **Architectural Ownership:** Architected the global system design, ensuring seamless integration between **Reactor** (Frontend) and **Fastify** (Backend).
- **Execution & Domain Division:** Designed the task structure, divided responsibilities across specialized domains, and coordinated parallel development streams via GitHub and ClickUp.
- **Technical Direction:** Led the implementation of the project’s most critical systems, including the framework runtime and real-time synchronization strategy.
- **Quality Assurance:** Validated completed work for architectural coherence, performance, and compliance with the project’s deterministic rendering goals.

---

### 🤝 The Collaborative Team
While Malik provided the architecture and project management, **ft_transcendence** was a collaborative effort involving three other specialized engineers:

- **Abdul Rahman (aalkaisi):** Scrum Master & Game Engine Lead. Engineered the core physics-based engines for Pong (2P, 4P, AI) and the turn-based logic for Connect 4.
- **Natalia (nmagdano):** Infrastructure & Backend Architect. Designed the containerized environment (Docker/NGINX) and implemented secure authentication and user persistence logic.
- **Santiago (saherrer):** Systems Lead. Engineered the tournament matchmaking system, bracket generation, AI difficulty tiers, and the persistent statistics dashboard.
...
**Reactor was engineered for total control over the execution model.** This ensures the deterministic timing and state consistency required for real-time systems where frame stability is a critical technical constraint.
